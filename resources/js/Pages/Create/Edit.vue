...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded flex-none">更新</button>

    <!-- 削除ボタンのクリック時に確認ダイアログを表示 -->
    <button @click="confirmDelete" class="bg-red-500 text-white px-4 py-2 rounded flex-none">削除</button>
  </div>
