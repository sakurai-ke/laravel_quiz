    ...
    <div class="max-w-3xl mx-auto px-4">
      ...
      <form @submit.prevent="updateQuiz">
        <div class="bg-white rounded shadow-md p-4">
          ...
          <div class="mb-4">
            <label for="question" class="block font-semibold mb-1">問題文:</label>
            <textarea v-model="quiz.question" id="question" class="w-full rounded-md p-2 border"></textarea>
          </div>
          <div class="mb-4">
          ...
          <div class="mb-4">
            ...
            <textarea v-model="quiz.hint" id="hint" class="w-full rounded-md p-2 border"></textarea>
          </div>
          <div class="mb-4">
            <label for="explain" class="block font-semibold mb-1">解説:</label>
            <textarea v-model="quiz.explain" id="explain" class="w-full rounded-md p-2 border"></textarea>
          </div>
        </div>
        <div class="mt-4">
